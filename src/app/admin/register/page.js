...
function Register() {
  ...
  return (
    <div className="min-h-screen">
      <div className="lg:bg-[url(/images/admin/register.svg)] lg:bg-auto lg:bg-no-repeat lg:bg-left bg-[linear-gradient(180deg,#01589A_0%,#13A3DF_100%)] flex-flex-col justify-center items-center w-full pt-[1.5rem] pb-[6.25rem] px-[1rem]">
        {/* Mobile */}
        <div className="lg:pt-[3.75rem] flex justify-between items-center">
          ...
          <div className="flex gap-[1.5rem] items-baseline">
            ...
            >
              ...
              <ChevronRight
                size={25}
                className="lg:text-white text-[#01589A]"
              />
            </button>
          </div>
        </div>
        ...
        <div className="lg:relative lg:w-[50%] lg:left-[38rem] lg:bottom-[4rem] lg:px-[5rem] w-full ">
          <h2 className="lg:text-[#000] lg:text-left lg:text-[2.5rem] font-serif font-bold text-[#fff] text-[2rem] text-center my-[2rem]">
            Register to get started
          </h2>
          <div className="lg:bg-none lg:border-none lg:p-0 lg:rounded-none bg-white rounded-lg p-[0.5rem] border border-solid border-white">
            <CustomForm
          ...
          <p className="lg:text-[#000] text-[#fff] text-base font-normal font-sans text-center mt-[2.5rem]">
            By confirming your email, you agree to our 
            <a href="" className="lg:text-[#000] text-[#fff] underline">
              Terms of Service
            </a>{" "}
